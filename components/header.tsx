        ...
        <nav className="hidden items-center gap-6 md:flex">
          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <Link href="/login" className="neon-border rounded-lg bg-linear-to-r from-cyan-500 to-blue-600 px-4 py-2 text-sm font-medium text-white shadow-lg shadow-cyan-500/50 transition-all hover:shadow-cyan-500/70">
                Get Started
              </Link>
            </>
          )}
        ...
        <div className="flex items-center gap-3 md:hidden">
          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <Link href="/login" className="rounded-lg bg-linear-to-r from-cyan-500 to-blue-600 px-3 py-1.5 text-sm font-medium text-white">
                Start
              </Link>
            </>
          )}
